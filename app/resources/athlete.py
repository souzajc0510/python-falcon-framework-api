...
class Athlete(object):
    post_request_args = {"name": fields.Str(required=True), "email": fields.Str(required=True),
                         "phone": fields.Int(required=True), "gender": fields.Str(required=True),
    ...
    def on_put(self, req, resp, id):
        try:
            ...
            cur = self.conn.cursor()
            get_q = " ".join(
                ["SELECT name,email,phone,gender,birthday FROM", self.resource_name.lower(), "wHERE",
            ...
            update_q = " ".join(
                ["UPDATE", self.resource_name.lower(), "SET name=%s, email=%s, phone=%s, gender=%s, birthday=%s WHERE",
    ...
    def on_post_collection(self, req, resp, args):
        try:
            ...
            params = {'name': args['name'], 'email': args['email'], 'phone': args['phone'], 'gender': args['gender'],
